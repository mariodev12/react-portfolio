	...
	render: function(){
		return (
			React.createElement("button", {className: "btn btn-primary", onClick: this.handleClick}, 
				React.createElement("i", {className: this.state.data})
			)
		);
	}
});

var DataRequest = React.createClass({displayName: "DataRequest",
	getInitialState: function(){
		return {data: null};
	},
	...
	render: function(){
		var content = this.state.data ? React.createElement("img", {src: this.state.data.image.medium}) : React.createElement(Loading, null);
		if(this.state.data){
			return (
				React.createElement("div", null, 
					React.createElement("div", {className: "col-md-2"}, 
						React.createElement("h2", null, this.state.data.name), 
						React.createElement("img", {src: this.state.data.image.medium})
					), 
					React.createElement("div", {className: "col-md-offset-1 col-md-9"}, 
						React.createElement("h4", null, "Summary"), 
						React.createElement("div", {dangerouslySetInnerHTML: {__html: this.state.data.summary}}), 
						React.createElement("h4", null, "Genres:"), 
						React.createElement("ul", null, 
							this.state.data.genres.map(function(x, i){
								return React.createElement("li", {key: i}, x)
							})
						), 
						React.createElement("h4", null, "Network: ", this.state.data.network.name), 
        ...
        React.createElement("div", {className: "container-fluid"}, 
          React.createElement("div", {className: "navbar-header"}, 
            React.createElement("a", {className: "navbar-brand", href: "#"}, 
              React.createElement("img", {alt: "Brand", src: "img/logo.png", width: "20"})
            )
          )
        )
      )
...
},{"./loading.js":6,"react":164}],5:[function(require,module,exports){
/** @jsx React.DOM */
...
},{"./Hello":1,"react":164,"react-dom":35}],6:[function(require,module,exports){
var React = require('react');

var Loading = React.createClass({displayName: "Loading",
  render: function(){
    return React.createElement("img", {src: "./img/default.gif"})
  }
});
